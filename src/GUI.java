                ...
                if (!types.isEmpty()) {
                    for (String item : types) {
                        ...
                        if (item.equals("Presentation")) {
                            newResource.addProperty(OntProp.hasPracticalPart, model.getIndividual(uri + item));
                            model.getIndividual(uri + item).addProperty(OntProp.isPracticalPart, newResource);

                        } else if (item.equals("Lecture")) {
                            newResource.addProperty(OntProp.hasTheoreticalPart, model.getIndividual(uri + item));
                            model.getIndividual(uri + item).addProperty(OntProp.isTheoreticalPart, newResource);
                        }
                    }
                }
